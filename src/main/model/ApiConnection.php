...
class ApiConnection
{
    ...
    public function getTrainTime($station)
    {
        $url = METRO_URL .'datapoints?rdf:type=odpt:StationTimetable&odpt:station='.$station.'&'.METRO_TOKEN;
    ...
    {
        $url = METRO_URL .'datapoints?rdf:type=odpt:Station&'.METRO_TOKEN;
